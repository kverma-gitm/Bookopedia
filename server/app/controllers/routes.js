...
var favBooks = mongoose.model('fav');
...
app.post('/fav',function(req,res){
    console.log("in fav api"+req.body._id);

    var book = new favBooks({
        bookid : req.body._id,
...
//api to get fav books

app.get('/getfav/:userid', function (req, res) {
    ...
    favBooks.find({
        ...
        if (err) {
            ...
            var response = resGenerator.generate(false, "All books fetched successfully", 200, bookid);
